...
export const FileUploadDropZone = ({
    ...
    return (
        <div
            ...
            onDrop={handleDrop}
            className={cx(
                'text-tertiary relative flex flex-col items-center gap-3 rounded-xl bg-primary px-6 py-4 ring-1 ring-secondary transition duration-100 ease-linear ring-inset',
        ...
        >
            ...
            <div className="flex flex-col gap-1 text-center">
                ...
                >
                    {hint || 'SVG, PNG, JPG, WEBP or PDF (max. 10 Mb, 5 files)'}
                </p>
            </div>
        </div>
    );
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-0.5 flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                {failed && (
                                    <XCircle className="text-fg-error-primary size-4" />
                                )}
                                {failed && (
