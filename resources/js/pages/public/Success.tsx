                                ...
                                {!auth?.user && (
                                    <div className="w-full p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/80 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4">
                                        <div className="flex items-start gap-3.5 text-left">
                                            <div className="p-2.5 rounded-xl bg-white shadow-sm border border-blue-100 text-blue-600 shrink-0">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs sm:text-sm text-slate-600 mt-0.5">
                                                    Sign in with Google to save your contact details, office, designation, and address so you won't need to re-enter them on future requests!
                                                </p>
                                            </div>
                                        </div>
                                        <Button
                                            asChild
                                            className="w-full md:w-auto shrink-0 h-11 px-5 rounded-xl bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 font-semibold text-sm shadow-sm transition-all flex items-center justify-center gap-2"
                                        >
                                            <a href={`/auth/google?ref=${formInput.reference_number}`}>
